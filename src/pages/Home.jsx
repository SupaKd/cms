  ...
  return (
    <main className="home-page">
      ...
      <section className="hero-section">
        ...
        <div className="hero-inner">
          ...
          >
            ...
            Fabrication française · Depuis 1990
          </motion.div>
          ...
          >
            Conçues avec précision dans nos ateliers français,<br />
            chaque monture incarne l'excellence du geste artisanal.
          </motion.p>
          ...
          >
            <a href="#animation3d" className="hero-btn-primary">
      ...
      <section id="story">
        ...
        >
          <p>
            Implantée au cœur du bassin lyonnais, berceau historique de la
            lunetterie française, Optical Store s’appuie sur une histoire
            humaine différente, portée par le parcours de Mme Durand, passionnée
            par l’artisanat et la précision du métier.
          </p>
          <p>
            Tout commence dans les années 1990, lorsque Mme Durand découvre
            l’univers de la lunetterie lors d’un apprentissage à Lyon. Fascinée
            par le travail minutieux de la monture, elle se spécialise
            rapidement dans les finitions et l’assemblage, développant un
            savoir-faire reconnu dans la région.
          </p>
          <p>
